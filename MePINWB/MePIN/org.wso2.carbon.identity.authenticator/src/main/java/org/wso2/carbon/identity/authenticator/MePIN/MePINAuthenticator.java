...
public class MePINAuthenticator extends AbstractApplicationAuthenticator
    ...
    public boolean canHandle(HttpServletRequest request) {
        ...
        return ((!StringUtils.isEmpty(request.getParameter(MePINConstants.MEPIN_ACCESSTOKEN)) && !StringUtils.isEmpty(request.getParameter(MePINConstants.USERNAME)) && !StringUtils.isEmpty(request.getParameter(MePINConstants.PASSWORD)))
    ...
    protected void processAuthenticationResponse(HttpServletRequest request,
        ...
        if ((!StringUtils.isEmpty(request.getParameter(MePINConstants.MEPIN_ACCESSTOKEN)))) {
            ...
            try {
                ...
                String responseString = new MePINTransactions().getUserInformation(authenticatorProperties.get(MePINConstants.MEPIN_USERNAME), authenticatorProperties.get(MePINConstants.MEPIN_PASSWORD), accessToken);
                if (!responseString.equals(MePINConstants.FAILED)) {
                    ...
                    associateFederatedIdToLocalUsername(authenticatedLocalUsername, context, getFederateAuthenticatedUser(context, mepinId));
                    context.setSubject(AuthenticatedUser.createLocalAuthenticatedUserFromSubjectIdentifier(authenticatedLocalUsername));
                } else {
            ...
            try {
                ...
                if (status.equalsIgnoreCase(MePINConstants.MEPIN_OK)) {
                    ...
                    while (retry < retryCount) {
                        ...
                        transactionStatusResponse = new MePINTransactions().getTransaction(MePINConstants.MEPIN_GET_TRANSACTION_URL,
