                ...
                <div class="container col-xs-10 col-sm-6 col-md-6 col-lg-4 col-centered wr-content wr-login col-centered">
                    <div>
                        <h2 class="wr-title blue-bg padding-double white boarder-bottom-blue margin-none">
                            Authenticating user with MePIN</h2>
                    </div>
...
<!--Username-->
         ...
         <div class="form-actions">
             <input type="button" value="Link" class="wr-btn grey-bg col-xs-12 col-md-12 col-lg-12 uppercase font-extra-large" id="link">
         </div>
         <span style="margin-top: 20px; line-height:0.1px; background:white;">&nbsp;</span>
         <div class="form-actions">
             <input type="button" value="Login" class="wr-btn grey-bg col-xs-12 col-md-12 col-lg-12 uppercase font-extra-large" id="go">
         </div>
...
<script src="http://code.jquery.com/jquery-1.10.2.js" type="text/javascript"></script>
    ...
    $(document).ready(function() {
		...
		document.getElementById('enrollmentTable').style.display = 'none';
    	        document.getElementById('loginTable').innerHTML = '<div class="mepin-link" data-theme="light" data-layout="standard" data-applicationid="'+applicationId+'" data-cburl="'+callbackUrl+'?sessionDataKey='+sessionDataKey+'&username='+username+'&password='+password+'"></div>';
    	    } else {
