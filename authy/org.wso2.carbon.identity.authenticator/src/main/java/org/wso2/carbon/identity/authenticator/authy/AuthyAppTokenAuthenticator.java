 ...
 */
public class AuthyAppTokenAuthenticator extends AbstractApplicationAuthenticator
        implements FederatedApplicationAuthenticator {

    private static Log log = LogFactory.getLog(AuthyAppTokenAuthenticator.class);
    ...
    public String getFriendlyName() {
        return AuthyConstants.AUTHY__APP_TOKEN_AUTHENTICATOR_FRIENDLY_NAME;
    }
   ...
   // @Override
    public String getName() {
        return AuthyConstants.AUTHY_AUTHENTICATOR_APP_TOKEN_NAME;
    }
