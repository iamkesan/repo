 ...
 */
public class AuthySMSAuthenticator extends AbstractApplicationAuthenticator
        implements FederatedApplicationAuthenticator {

    private static Log log = LogFactory.getLog(AuthySMSAuthenticator.class);
    ...
    public boolean canHandle(HttpServletRequest request) {
        ...
        log.info("AUTHY confirmationCode :" + confirmationCode);
    ...
    public String getFriendlyName() {
        return AuthyConstants.AUTHY_SMS_AUTHENTICATOR_FRIENDLY_NAME;
    }
    ...
    public String getName() {
        return AuthyConstants.AUTHY_AUTHENTICATOR_SMS_NAME;
    }
